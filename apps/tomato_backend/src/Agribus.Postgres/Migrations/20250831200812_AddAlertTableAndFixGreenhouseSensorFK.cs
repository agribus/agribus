...
namespace Agribus.Postgres.Migrations
{
    ...
    public partial class AddAlertTableAndFixGreenhouseSensorFK : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    threshold_value = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    range_min_value = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    range_max_value = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint(
                        ...
                        "measure_type IN ('temperature', 'humidity', 'pressure', 'motion', 'rssi', 'neighbors', 'unknown')"
                    );
                    table.CheckConstraint(
                        "CK_RuleType_IsValid",
                        "rule_type IN ('above', 'below', 'outside', 'inside')"
                    );
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "alert");
        }
    }
}
